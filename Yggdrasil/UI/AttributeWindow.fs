...
let FillPrimaryAttributes win (attr: _ array) (costs: _ array) =
    ...
    NCurses.MoveWindowAddString(win, 1, 2, $"STR {attr.[int Primary.STR]} ^{costs.[int Primary.STR]}") |> ignore
    NCurses.MoveWindowAddString(win, 2, 2, $"AGI {attr.[int Primary.AGI]} ^{costs.[int Primary.AGI]}") |> ignore
    NCurses.MoveWindowAddString(win, 3, 2, $"VIT {attr.[int Primary.VIT]} ^{costs.[int Primary.VIT]}") |> ignore
    NCurses.MoveWindowAddString(win, 4, 2, $"INT {attr.[int Primary.INT]} ^{costs.[int Primary.INT]}") |> ignore
    NCurses.MoveWindowAddString(win, 5, 2, $"DEX {attr.[int Primary.DEX]} ^{costs.[int Primary.DEX]}") |> ignore
    NCurses.MoveWindowAddString(win, 6, 2, $"LUK {attr.[int Primary.LUK]} ^{costs.[int Primary.LUK]}") |> ignore
