...
let ToRawAttribute data : RawTypes.RawAttribute = data |> ToUInt16 |> LanguagePrimitives.EnumOfValue
//let ToString (data: _[]) = Encoding.UTF8.GetString(data).Split('\x00').[0]
